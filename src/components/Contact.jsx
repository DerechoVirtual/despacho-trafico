        ...
        <div className="grid lg:grid-cols-[1.4fr_1fr] gap-10 items-start">
          ...
          <div className="bg-white border border-black/5 rounded-2xl p-8 shadow-lg">
            <form onSubmit={handleSubmit} noValidate>
              ...
              <button
                type="submit"
                className="w-full rounded-xl bg-gold px-6 py-4 font-semibold text-white shadow-md transition hover:bg-gold-dark hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-gold/50 active:scale-[0.98]"
              >
                Enviar mi consulta gratis
              </button>
            </form>
          </div>
          ...
          <aside className="bg-navy text-white rounded-2xl p-8 shadow-lg">
            <h3 className="font-display text-2xl font-bold mb-7">
              Habla con nosotros
            </h3>
            ...
            <ul className="space-y-5 mb-8">
              ...
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="tel:900000000"
                    className="text-white font-medium hover:text-gold transition"
                  >
                    900 000 000
                  </a>
                </div>
              ...
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    href="mailto:info@riveroabogados.es"
                    className="text-white font-medium hover:text-gold transition"
                  >
              ...
              <li className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-white font-medium">
                    Alicante · atención nacional online
                  </p>
                </div>
              </li>
            ...
            <div className="border-t border-white/10 pt-6">
              ...
              <p className="text-white/60 text-sm leading-relaxed">
                Tratamos tu información con total confidencialidad y conforme
                al RGPD. Nunca la compartiremos con terceros.
              </p>
            </div>
          </aside>
        </div>
